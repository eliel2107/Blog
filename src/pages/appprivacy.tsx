        ...
        <div className={styles.title}>
          ...
          <div className={styles.content}>
            ...
            <p>
              ...
              Tecnologia Ltda. (&quot;LW Tecnologia&quot;) CNPJ:
              44.383.200/0001-46. Ao utilizar nossos serviços, você concorda com
              esta política. Caso não concorde, a utilização dos nossos serviços
              deverá ser interrompida e o DPO deverá ser notificado por meio do
              e-mail informado nesta política.
            </p>
            <p>1. Informações que coletamos</p>
            <h1>1.1. Informações Pessoais</h1>
            <p>
            ...
            <h1>1.2. Informações Coletadas Automaticamente</h1>
            <p>
            ...
            <p>Dados de localização, se permitido por você.</p>

            <h1>
              1.3. Informações Coletadas por Cookies e Tecnologias Semelhantes
            </h1>
            <p>
            ...
            <p>Processar pedidos e melhorar a experiência do usuário;</p>
            <p>Manter e aprimorar o aplicativo e a plataforma;</p>
            <p>
              Comunicar atualizações, responder a dúvidas e oferecer suporte;
            </p>
            ...
            <p>
              Com fornecedores de serviços que ajudam a operar o aplicativo ou a
              plataforma;
            </p>
            <p>
              Para cumprir com obrigações legais, ordens judiciais ou processos
              legais;
            </p>
            <p>
            ...
            <h2>7. Revogação de Consentimento</h2>
            <p>
            ...
            <p>
              Fornecer informações reais e atualizadas nos campos cadastrais da
              plataforma;
            </p>
            <p>
