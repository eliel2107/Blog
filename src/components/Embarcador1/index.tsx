                        ...
                        <div className={styles.overlay}>
                            <div className={styles.rightside}>
                                <div className={styles.serviços}>
                                    ...
                                    <p>
                                        Plataforma de devolução e venda de
                                        veículos <br />
                                        ao final de contrato com agilidade,
                                    ...
                                    <div className={styles.top}>
                                        <div className={styles.serviceslefttop}>
                                            ...
                                            <p>
                                                Devolução do veículo após envios
                                                periódicos de avisos ao condutor
                                                sobre o fim do contrato e
                                                pré-agendamento de devolução.
                                            </p>
                                        </div>
                                        <div
                                        ...
                                        >
                                            ...
                                            <p>
                                                ...
                                                visualização dos itens do laudo
                                                de vistoria além do processo de
                                        ...
                                        >
                                            ...
                                            <p>
                                                Auxilia a criação de um
                                                orçamento do veículo com o valor
                                                total de avarias, multas e
                                                débitos durante o período
