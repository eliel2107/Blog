                    ...
                    <div className={styles.overlay}>
                        <div className={styles.rightside}>
                            <div className={styles.serviços}>
                                <h2>LW MULTAS</h2>
                                <p>
                                    Agilidade e eficiência na Gestão de
                                    Infrações, com 3 opções de planos:
                                </p>
                                <div className={styles.top}>
                                    <div className={styles.serviceslefttop}>
                                        ...
                                        <ul>
                                            <li>
                                                Consulta de multas em uma
                                                plataforma Web;
                                            </li>
                                            <li>
                                                Gestão de notificações e boleto;
                                            </li>
                                            <li>
                                    ...
                                    <div className={styles.servicesrighttop}>
                                        ...
                                        <ul>
                                            <li>Plano Lite +</li>
                                            <li>
                                                Gestão terceirizada de indicação
                                                do condutor;
                                            </li>
                                            <li>
                                                Acesso às tratativas e
