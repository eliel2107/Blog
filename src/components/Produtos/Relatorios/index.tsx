      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.rightside}>
            <h1>RELATÓRIOS</h1>
            <p>
              Com os relatórios, o usuário pode acompanhar os pagamentos dos
              débitos da sua frota e ter acesso quando precisar aos relatórios e
              comprovantes bancários diretamente pelo sistema.
            </p>
