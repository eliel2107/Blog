                    ...
                    <div className={styles.middlecontent}>
                        <div className={styles.lefttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Acessamos o portal e visualizamos a
                                    documentação dos condutores inserida pelos
                                    nossos clientes.
                                </p>
                            </div>
                        </div>
                        <div className={styles.righttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Inserimos a documentação no site do órgão e
                                    aguardamos o protocolo.
                                </p>
                            </div>
                        </div>
                        <div className={styles.leftbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Analisamos, validamos e compilamos os
                                    documentos.
                                </p>
                            </div>
                        </div>
                        <div className={styles.rightbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Recebemos a confirmação da indicação em até
                                    48 horas.
                                </p>
                            </div>
                        </div>
                        <div className={styles.leftbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Enviamos os documentos para assinatura
                                    digital.
                                </p>
                            </div>
                        </div>
                        <div className={styles.rightbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Se necessário, analisamos e orientamos
                                    nossos clientes sobre as alterações
                                    necessárias para reenvio.
                                </p>
                            </div>
                        </div>
                    </div>
