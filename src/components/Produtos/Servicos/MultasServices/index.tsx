                        ...
                        <div className={styles.middlecontent}>
                            <div className={styles.lefttop}>
                                ...
                                <div className={styles.text}>
                                    ...
                                    <p>
                                        Infrações disponíveis para consulta,
                                        conforme região homologada
                                    </p>
                                </div>
                            </div>
                            <div className={styles.righttop}>
                                ...
                                <div className={styles.text}>
                                    ...
                                    <p>
                                        Recebimento de e-mail referente a nova
                                        infração, validação ou rejeição da
                            ...
                            <div className={styles.leftbottom}>
                                ...
                                <div className={styles.text}>
                                    ...
                                    <p>
                                        Validação da indicação realizada pelo
                                        condutor pelo LW Multas.
                                    </p>
                                </div>
                            </div>
                            <div className={styles.rightbottom}>
                                ...
                                <div className={styles.text}>
                                    ...
                                    <p>
                                        Realização de pagamentos de infrações
                                        dos veículos de forma automatizada pelo
                                        LW Multas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <>
                                <div className={styles.bottomcontent}>
                                    ...
                                    <div className={styles.text}>
                                        ...
                                        <p>
                                            Recebimento de link para indicação
                                            no e-mail do condutor.
                                        </p>
                                    </div>
                                </div>
                            </>
