                    ...
                    <div className={styles.middlecontent}>
                        <div className={styles.lefttop}>
                            ...
                            <div className={styles.text}>
                                <h2>CONSULTAS</h2>
                                <p>
                                    Consulte o valor e data de vencimentos dos
                                    débitos de <br />
                        ...
                        <div className={styles.righttop}>
                            ...
                            <div className={styles.text}>
                                <h2>RELATÓRIOS</h2>
                                <p>
                                    Acompanhe o pagamento dos débitos e extraia
                                    relatórios e comprovantes quando precisar.
                                </p>
                            </div>
                        </div>
                        <div className={styles.leftbottom}>
                            ...
                            <div className={styles.text}>
                                <h2>PAGAMENTOS</h2>
                                <p>
                                    Solicitação de pagamento dos débitos
