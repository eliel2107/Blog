                    ...
                    <div className={styles.middlecontent}>
                        <div className={styles.lefttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Acompanhe e gerencie seus processos através
                                    de um sistema exclusivo.
                                </p>
                            </div>
                        </div>
                        <div className={styles.righttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Tenha os dados necessários dentro da sua
                                    própria plataforma.
                                </p>
                            </div>
                        </div>
                        <div className={styles.leftbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Tenha mais agilidade nos serviços através da
                                    tecnologia.
                                </p>
                            </div>
                        </div>
                        <div className={styles.rightbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Nosso sistema é desenvolvido por uma equipe
                                    própria que está pronta para atender as
                                    demandas e melhorias.
                                </p>
                            </div>
                        </div>
                    </div>
