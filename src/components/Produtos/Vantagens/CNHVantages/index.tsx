          ...
          <div className={styles.middlecontent}>
            ...
            <div className={styles.righttop}>
              ...
              <div className={styles.text}>
                ...
                <p>
                  A ação é mais rápida em casos de aumento significativo na
                  pontuação ou CNH suspensa.
                </p>
              </div>
            </div>
            <div className={styles.leftbottom}>
              ...
              <div className={styles.text}>
                ...
                <p>
                  Com o monitoramento da situação da CNH pode-se evitar
                  penalidades e multas, além de garantir a regularidade da sua
                  frota.
                </p>
              </div>
            </div>
