                    ...
                    <div className={styles.middlecontent}>
                        <div className={styles.lefttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Consulte as infrações dos seus veículos em
                                    uma única plataforma e facilite a gestão da
                                    sua frota.
                                </p>
                            </div>
                        </div>
                        <div className={styles.righttop}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Gerencie e otimize seus processos através
                        ...
                        <div className={styles.leftbottom}>
                            ...
                            <div className={styles.text}>
                                <h2>
                                    Equipe Especializada no Processo de
                                    Indicação
                                </h2>
                                <p>
                                    Análise de documentação focada na
                                    identificação de erros antes do envio ao
                                    órgão responsável, auxiliando na prevenção
                                    de NICs.
                                </p>
                            </div>
                        </div>
                        <div className={styles.rightbottom}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    Agilidade na quitação de infrações,
                                    possibilitando pagamentos com 20% de
                                    desconto e resultando em economia
