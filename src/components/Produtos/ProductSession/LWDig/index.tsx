          ...
          <div className={styles.rightside}>
            <div className={styles.serviços}>
              <div className={styles.title}>
                <h2>DIGITALIZAÇÃO</h2>
                <p>
                  É um serviço criado para empresas que buscam melhorar a
                  eficiência de suas operações relacionadas a multas. Seja a
                  falta de recursos internos ou a necessidade de concentrar sua
                  equipe em outras tarefas.
                </p>
              </div>
