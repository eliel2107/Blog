                        ...
                        <div className={styles.overlay}>
                            <div className={styles.rightside}>
                                <div className={styles.serviços}>
                                    ...
                                    <p>
                                        Serviço operacional de controle de
                                        frotas de veículos.
                                    </p>
                                    <div className={styles.top}>
                                        ...
                                        >
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    É possível definir se houve
                                                    imprudência por parte do
                                                    condutor.
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <ul>
                                                <li>
                                                    Plataforma personalizada com
                                                    logo e URL do cliente,
                                                    disponibilizado para mobile
                                                    e Web.
                                                </li>
                                            </ul>
                                        </div>
