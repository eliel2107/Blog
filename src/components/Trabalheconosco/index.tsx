            ...
            <div className={styles.container} id="trabalhe">
                <div className={styles.content}>
                    <div className={styles.leftside}>
                        <img
                            src="https://d10fqir6n4h7sq.cloudfront.net/public/LWCOFFE.jpg"
                            alt=""
                        />
                    </div>
                    <div className={styles.rightside}>
                        <div className={styles.title}>
                            ...
                            <p>
                                Preencha o formulário abaixo e você fará parte
                                do nosso banco de talentos e terá preferência no
                                contato ao surgir novas vagas.
                            </p>
                        </div>
