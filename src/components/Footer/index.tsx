        ...
        <>
            <section className={styles.container}>
                ...
                <div className={styles.info}>
                    ...
                    <p>
                        Endereço Curitiba: R. XV de Novembro, 621 2º andar
                        Centro, Curitiba PR, 80020-310
                    </p>
                    <p>
                        Filial Rio de Janeiro: Rua General Olimpio, nº 00340,
                        Bairro Santa Cruz, CEP 23.515-127, na Cidade de Rio de
                        Jeneiro, Estado de Rio de Janeiro.
                    </p>
                </div>
            </section>
                ...
                <div className={styles.contentresponsive}>
                    <div className={styles.topcontentresponsive}>
                        ...
                        <div className={styles.infoResponsive}>
                            ...
                            <p>Email: comercial@lwtecnologia.com.br</p>
                            <p>
                                Endereço: R. XV de Novembro, 621 2º andar
                                Centro, Curitiba PR, 80020-310
                            </p>
                            <p>
                                Filial Rio de Janeiro: Rua General Olimpio, nº
                                00340, Bairro Santa Cruz, CEP 23.515-127, na
                                Cidade de Rio de Jeneiro, Estado de Rio de
                                Janeiro.
                            </p>
                        </div>
                    </div>
