                ...
                <div className={styles.content}>
                    <div className={styles.top}>
                        ...
                        <div className={styles.rightop}>
                            <p>Recentes</p>{' '}
                            <img
                                src="https://d10fqir6n4h7sq.cloudfront.net/public/CaretDown.svg"
                                alt=""
                            />
                        </div>
                    </div>
                        ...
                        <div className={styles.l}>
                            <Link href="/post">
                                ...
                                <div className={styles.text}>
                                    ...
                                    <p>
                                        Aenean eleifend ante maecenas pulvinar
                                        montes lorem et pede dis dolor pretium
                                        donec dictum. Vici consequat justo enim.
                                        Venenatis eget adipiscing luctus
                                        loremVici consequat justo enim.
                        ...
                        <div className={styles.l}>
                            ...
                            <div className={styles.text}>
                                ...
                                <p>
                                    ...
                                    dictum. Vici consequat justo enim. Venenatis
                                    eget adipiscing luctus loremVici consequat
                                    justo enim. Venenatis eget adipiscing luctus
                                    lorem.
                                </p>
                                <div className={styles.link}>
                                    <p>Ver post</p>
