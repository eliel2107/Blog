            ...
            <Link href="/post">
              <div className={styles.leftside}>
                ...
                <div className={styles.textleft}>
                  <h1>
                    Tipos de frotas: conheça as características de cada uma
                  </h1>
                  <p>
                    Uma frota se caracteriza pelo conjunto de veículos que estão
                    a serviço de uma empresa. É comum vermos as frotas de
                    caminhões, mas além delas há diversos outros tipos de
                    frotas. Cada tipo possui suas próprias características e
                    modelos de veículos para...
                  </p>
                </div>
              </div>
            </Link>
                ...
                <div className={styles.Toptheme}>
                  ...
                  <div className={styles.theme2}>
                    ...
                    <div className={styles.textcontent2}>
                      ...
                      <h1>
                        O QUE É LICENCIAMENTO DE VEÍCULO? ENTENDA SUA
                        IMPORTÂNCIA
                      </h1>
                    </div>
                  </div>
